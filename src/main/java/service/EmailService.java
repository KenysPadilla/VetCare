...
public class EmailService {
    ...
    public void enviarConfirmacionCita(String destinatario, String nombrePropietario,
        ...
        try (InputStream in = getClass().getResourceAsStream("/config.properties")) {
            ...
            final String host = mailConfig.getProperty("mail.host");
            final String port = mailConfig.getProperty("mail.port");
            final String usuario = mailConfig.getProperty("mail.usuario");
            final String password = mailConfig.getProperty("mail.password");
            final String remitente = mailConfig.getProperty("mail.remitente");
